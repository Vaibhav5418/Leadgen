              ...
              <label htmlFor="alm-linkedin-account" className="block text-xs font-semibold text-gray-700 mb-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors whitespace-nowrap"
                  >
                ...
                {showAddAccount && (
                  <div className="mt-3 flex gap-2">
                    ...
                    <button
                      ...
                      disabled={!newAccountName.trim() || linkedInAccounts.includes(newAccountName.trim())}
