        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4 transform animate-fade-in-up">
            ...
            <p className="text-sm text-gray-700 mb-6">
              Are you sure you want to remove <span className="font-bold text-gray-900">{selectedContacts.size}</span> {selectedContacts.size === 1 ? 'prospect' : 'prospects'} from this project? They will be removed from this project.
            </p>
